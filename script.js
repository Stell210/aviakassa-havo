...
navSearch:"Найти билет",navFlights:"Рейсы",navOffers:"Акции",flightsEyebrow:"АКТУАЛЬНЫЕ РЕЙСЫ",flightsTitle:"Рейсы",flightsIntro:"Актуальные варианты, которые менеджер добавил через админ-панель.",offersEyebrow:"АКЦИИ",offersTitle:"Специальные предложения",offersIntro:"Акции и выгодные предложения от Aviakassa_havo.",searchEyebrow:"ПОИСК",searchTitle:"Найти рейс",searchButton:"Найти",allAirlines:"Все авиакомпании",allAirports:"Все аэропорты",sortDate:"По дате",sortPrice:"Сначала дешевле",sortTime:"По времени",adminPanelLink:"Админ-панель",navRoutes:"Направления",navHow:"Как это работает",navFaq:"FAQ",badge:"🌍 Душанбе → весь мир",
...
navSearch:"Чипта ёфтан",navFlights:"Парвозҳо",navOffers:"Аксияҳо",flightsEyebrow:"ПАРВОЗҲОИ ҶОРӢ",flightsTitle:"Парвозҳо",flightsIntro:"Вариантҳои ҷорӣ, ки менеҷер тавассути панели админӣ илова кардааст.",offersEyebrow:"АКСИЯҲО",offersTitle:"Пешниҳодҳои махсус",offersIntro:"Аксияҳо ва пешниҳодҳои муфид аз Aviakassa_havo.",searchEyebrow:"ҶУСТУҶӮ",searchTitle:"Парвозро ёбед",searchButton:"Ёфтан",allAirlines:"Ҳамаи ширкатҳои ҳавопаймоӣ",allAirports:"Ҳамаи фурудгоҳҳо",sortDate:"Аз рӯи сана",sortPrice:"Аввал арзонтар",sortTime:"Аз рӯи вақт",adminPanelLink:"Панели админӣ",navRoutes:"Самтҳо",navHow:"Чӣ тавр кор мекунад",badge:"🌍 Душанбе → тамоми ҷаҳон",
...
navSearch:"Find a ticket",navFlights:"Flights",navOffers:"Offers",flightsEyebrow:"CURRENT FLIGHTS",flightsTitle:"Flights",flightsIntro:"Current options added by a manager through the admin panel.",offersEyebrow:"OFFERS",offersTitle:"Special offers",offersIntro:"Offers and deals from Aviakassa_havo.",searchEyebrow:"SEARCH",searchTitle:"Find a flight",searchButton:"Search",allAirlines:"All airlines",allAirports:"All airports",sortDate:"By date",sortPrice:"Cheapest first",sortTime:"By time",adminPanelLink:"Admin panel",navRoutes:"Destinations",navHow:"How it works",badge:"🌍 Dushanbe → the world",
...
ru:{searchFrom:"Откуда",searchTo:"Куда",namePlaceholder:"Имя",phonePlaceholder:"+992...",toPlaceholder:"Москва",requestSaving:"Сохраняем заявку…",requestAccepted:"Заявка принята. Открываем WhatsApp…",whatsAppGreeting:"Здравствуйте! Хочу подобрать авиабилет.",offerAction:"Узнать варианты →",flightAction:"Узнать / оформить в WhatsApp",flightDetail:"Подробнее",searching:"Ищем рейсы…",searchNoResults:"Рейсы не найдены",searchError:"Не удалось выполнить поиск",until:"До",noFlights:"Сейчас нет опубликованных рейсов. Следите за обновлениями.",noOffers:"Сейчас нет активных акций.",noDirections:"Сейчас нет опубликованных направлений.",citiesAll:["Душанбе, Таджикистан","Москва, Россия","Казань, Россия","Санкт-Петербург, Россия","Дубай, ОАЭ","Стамбул, Турция"],cityNames:["Москва","Санкт-Петербург","Дубай","Стамбул"],routeNames:["Душанбе → Москва","Душанбе → Санкт-Петербург","Душанбе → Дубай","Душанбе → Стамбул"]},
tj:{searchFrom:"Аз куҷо",searchTo:"Ба куҷо",namePlaceholder:"Ном",phonePlaceholder:"+992...",toPlaceholder:"Москва",requestSaving:"Дархостро нигоҳ медорем…",requestAccepted:"Дархост қабул шуд. WhatsApp кушода мешавад…",whatsAppGreeting:"Салом! Ман мехоҳам чиптаи ҳавопаймо интихоб кунам.",offerAction:"Вариантҳоро дидан →",flightAction:"Пурсидан / фармоиш дар WhatsApp",flightDetail:"Муфассалтар",searching:"Парвозҳоро ҷустуҷӯ мекунем…",searchNoResults:"Парвозҳо ёфт нашуданд",searchError:"Ҷустуҷӯи парвоз иҷро нашуд",until:"То",noFlights:"Ҳоло парвози нашршуда нест. Навсозиҳоро пайгирӣ кунед.",noOffers:"Ҳоло аксияи фаъол нест.",noDirections:"Ҳоло самти нашршуда нест.",citiesAll:["Душанбе, Тоҷикистон","Москва, Россия","Қазон, Россия","Санкт-Петербург, Россия","Дубай, АМА","Истанбул, Туркия"],cityNames:["Москва","Санкт-Петербург","Дубай","Истанбул"],routeNames:["Душанбе → Москва","Душанбе → Санкт-Петербург","Душанбе → Дубай","Душанбе → Истанбул"]},
en:{searchFrom:"From",searchTo:"To",namePlaceholder:"Name",phonePlaceholder:"+992...",toPlaceholder:"Moscow",requestSaving:"Saving your request…",requestAccepted:"Request received. Opening WhatsApp…",whatsAppGreeting:"Hello! I would like to find a flight.",offerAction:"See options →",flightAction:"Ask / book via WhatsApp",flightDetail:"Details",searching:"Searching for flights…",searchNoResults:"No flights found",searchError:"Could not complete the search",until:"Until",noFlights:"There are no published flights yet. Follow updates.",noOffers:"There are no active offers.",noDirections:"There are no published destinations.",citiesAll:["Dushanbe, Tajikistan","Moscow, Russia","Kazan, Russia","Saint Petersburg, Russia","Dubai, UAE","Istanbul, Turkey"],cityNames:["Moscow","Saint Petersburg","Dubai","Istanbul"],routeNames:["Dushanbe → Moscow","Dushanbe → Saint Petersburg","Dushanbe → Dubai","Dushanbe → Istanbul"]}
};
...
function setLang(l){
 ...
 window.dispatchEvent(new CustomEvent("aviakassa:language",{detail:l}));
}



window.aviakassaDetailLabels={
 ru:{date:"Дата",time:"Время",airline:"Авиакомпания",baggage:"Багаж",departure:"Вылет",arrival:"Прилёт",price:"Цена",book:"Забронировать",bookingMessage:"Здравствуйте! Хочу забронировать рейс"},
 tj:{date:"Сана",time:"Вақт",airline:"Ширкати ҳавопаймоӣ",baggage:"Бағоҷ",departure:"Парвоз",arrival:"Расидан",price:"Нарх",book:"Фармоиш додан",bookingMessage:"Салом! Ман мехоҳам парвозро фармоиш диҳам"},
 en:{date:"Date",time:"Time",airline:"Airline",baggage:"Baggage",departure:"Departure",arrival:"Arrival",price:"Price",book:"Book",bookingMessage:"Hello! I would like to book the flight"}
};
...
(function(){
  ...
  window.addEventListener("aviakassa:language",()=>{ loadPublicContent(); });
